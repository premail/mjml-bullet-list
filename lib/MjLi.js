...
var MjLi = /*#__PURE__*/function (_BodyComponent) {
  ...
  _createClass(MjLi, [{
    ...
    value: function getStyles() {
      var textColor = this.getAttribute('text-color') || this.getAttribute('color');
      return {
        ulStyle: {
